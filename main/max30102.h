...
void max30102_set_ppg_rdy(i2c_master_dev_handle_t *dev_handle, uint8_t enable);
void max30102_set_alc_ovf(i2c_master_dev_handle_t *dev_handle, uint8_t enable);
...
void max30102_on_interrupt(i2c_master_dev_handle_t *dev_handle);
uint8_t max30102_has_interrupt(i2c_master_dev_handle_t *dev_handle);
void max30102_interrupt_handler(i2c_master_dev_handle_t *dev_handle);

void max30102_shutdown(i2c_master_dev_handle_t *dev_handle, uint8_t shdn);
...
void max30102_set_multi_led_slot_1_2(i2c_master_dev_handle_t *dev_handle, max30102_multi_led_ctrl_t slot1, max30102_multi_led_ctrl_t slot2);
void max30102_set_multi_led_slot_3_4(i2c_master_dev_handle_t *dev_handle, max30102_multi_led_ctrl_t slot3, max30102_multi_led_ctrl_t slot4);
...
void max30102_read_temp(i2c_master_dev_handle_t *dev_handle, int8_t *temp_int, uint8_t *temp_frac);
